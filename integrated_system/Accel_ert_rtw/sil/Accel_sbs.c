...
#define S_FUNCTION_NAME                Accel_sbs
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("car_model_SIL");
      mxArray *rhs[3];
      const char * simulinkBlockPath = ssGetPath(S);
      rhs[ 0 ] = mxCreateString(
        "@coder.connectivity.SimulinkInterface.getSILPILInterface");
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetInputPortSampleTime(S, 0, 0.6);
  ...
  /* using port based sample times */
  ssSetInputPortSampleTime(S, 1, 0.6);
  ...
  /* using port based sample times */
  ssSetInputPortSampleTime(S, 2, 0.6);
  ...
  /* using port based sample times */
  ssSetInputPortSampleTime(S, 3, 0.6);
  ...
  /* using port based sample times */
  ssSetInputPortSampleTime(S, 4, 0.6);
  ...
  /* using port based sample times */
  ssSetInputPortSampleTime(S, 5, 0.6);
  ...
  /* using port based sample times */
  ssSetOutputPortSampleTime(S, 0, 0.6);
