...
## Generated on : Tue Jul 07 17:05:53 2020
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/Accel_ert_rtw/coderassumptions -I$(START_DIR)/Accel_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
OBJS = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj Accel_ca.obj
...
%.obj : $(START_DIR)/Accel_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


%.obj : $(START_DIR)/Accel_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
...
Accel_ca.obj : $(START_DIR)/Accel_ert_rtw/coderassumptions/Accel_ca.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
